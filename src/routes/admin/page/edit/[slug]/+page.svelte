<script lang="ts">
	...
	let name = page?.name || "";
	let slug = page?.slug || "";
	let metaTitle = page?.meta?.title || "";
	let metaDescription = page?.meta?.description || "";
	let openGraphTitle = page?.meta?.openGraph?.title || "";
	let openGraphDescription = page?.meta?.openGraph?.description || "";
	let openGraphType = page?.meta?.openGraph?.type || "";
	let openGraphImages = page?.meta?.openGraph?.images || [];
	let twitterTitle = page?.meta?.twitter?.title || "";
	let twitterDescription = page?.meta?.twitter?.description || "";
	let twitterCard = page?.meta?.twitter?.card || "";
	let twitterImage = page?.meta?.twitter?.image || "";
	let twitterImageAlt = page?.meta?.twitter?.imageAlt || "";
...
<form class="page-form" on:submit|preventDefault={handleFormSubmit}>
	...
	<button on:click|preventDefault={handleFormSubmit}>Update</button>
</form>
