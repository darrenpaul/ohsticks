...
const eCommerceProduct = (searchPrompt: string) => {
	return [
		...
		"Provide a bulleted list of 10 broad match keywords that you used to create the product description, be sure to key this as keywords",
		...
		"Create a short description of the product that is between 50 and 60 characters long, be sure to key this as productDescription",
